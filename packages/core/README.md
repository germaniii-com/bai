...
| `src/provider/` | **Moved out** → the `@bai/provider` package (LLM adapters, catalog, credentials, OAuth, router SDK). Core re-exports it (`export * from "@bai/provider"`) and depends on it. |
